  ...
  fluidRow(
    column(
      ...
      wellPanel(
        ...
        div(style = "display:inline-block", downloadButton("download_example_data_bn", "Download input files"))
      ),
      wellPanel(
      ...
      br(),
      wellPanel(
        div(style = "display:inline-block", radioButtons("estim_mode", "Choose the fitting mode",
          selected = "only_prop",
          c(
            "no estimation, apply the fixed processing values" = "explicit",
            "estimate only proportion" = "only_prop",
            "estimate proportion and other processing parameters" = "prop_preproc"
          )
        )),
        conditionalPanel(
      ...
      wellPanel(
        ...
        div(style = "display:inline-block", h4(" ")),
        div(style = "display:inline-block", downloadButton("download_spectral_data_bn", "Download outcome data")),
        br(), br(),
